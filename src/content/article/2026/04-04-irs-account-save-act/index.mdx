...
What I found instead was a process that looked modern on paper but felt brittle in practice. The IRS does now push people toward its [online account for individuals](https://www.irs.gov/payments/online-account-for-individuals), which is positioned as a central place to check refunds, view notices, access tax records, and manage account details. The agency has also published material on [modernizing payments to and from America's bank account](https://www.irs.gov/newsroom/modernizing-payments-to-and-from-americas-bank-account), describing a broader push toward faster, more digital, more direct financial interactions with taxpayers. On paper, that sounds like everything I would want.
